...
public readonly record struct Style(Color? Foreground, Color? Background, Modifier AddModifier, Modifier RemoveModifier)
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Style"/> struct.
    /// </summary>
    public Style()
        : this(null, null, Modifier.Empty, Modifier.Empty)
    {
    ...
    /// </summary>
    public static Style Reset { get; } = new(Color.Reset, Color.Reset, Modifier.Empty, Modifier.All);
}
